...
public class Swapper
{
    ...
    public static void SetupCustomOption()
    {
        ...
        KillCooldown = FloatOptionItem.Create(51923 + 10, "JHSKillCooldown", new(5f, 15f, 2.5f), 5f, TabGroup.NeutralRoles, false).SetParent(Options.CustomRoleSpawnChances[CustomRoles.Swapper])
