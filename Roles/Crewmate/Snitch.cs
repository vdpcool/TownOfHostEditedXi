...
public static class Snitch
{
    ...
    private static bool IsSnitchTarget(PlayerControl target) => IsEnable && (target.Is(CustomRoleTypes.Impostor) || (target.IsNKS() && CanFindNeutralKiller) || (target.Is(CustomRoles.Madmate) && CanFindMadmate));
